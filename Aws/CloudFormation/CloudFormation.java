...
スタックの作成/削除時に起きていること
// スタックを作成すると、YAML ファイルどおりのコンポーネントが自動作成される。
// スタックを作成すると、そのスタックによって作成されたすべてのコンポーネントが削除される

スタックの更新時に起きていること
// メタデータ？はそのままだが、元ファイルについては、編集をするというより、
